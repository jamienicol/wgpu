...
impl Writer {
    ...
    fn write_function(
        ...
        let force_loop_bounding = self.force_loop_bounding;
        ...
        if force_loop_bounding {
            context.add_force_loop_bounding_vars(&ir_function.body);
        }
